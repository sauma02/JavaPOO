...
//Para recorrer un enum si utiliza un for each, los valores de los en um solo se divien por comas y se declaran de esta manera (dato1, dato2.... ;)
//No se compara con equals sin antes convertir a string el valor ya que no corresponden al mismo tipo de dato
//Con el metodo ordina() nos va a mostrar la posicion de cada dato dentro del enum
